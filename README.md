forgottenserver [![Build Status](https://github.com/otland/forgottenserver/actions/workflows/build-vcpkg.yml/badge.svg?branch=master)](https://github.com/otland/forgottenserver/actions/workflows/build-vcpkg.yml "vcpkg build status") [![Build Status](https://github.com/glinharesb/forgottenserver-1.4/actions/workflows/docker-image.yml/badge.svg?branch=main)](https://github.com/glinharesb/forgottenserver-1.4/actions/workflows/docker-image.yml "Docker image build status")
===============
